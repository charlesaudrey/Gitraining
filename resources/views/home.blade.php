                                ...
                                <div class="card animate fadeLeft">
                                    <div class="card-content cyan white-text">
                                        <p class="card-stats-title"><i class="material-icons">person_outline</i> New
                                            Clients</p>
                                        <h4 class="card-stats-number white-text">56</h4>
                                ...
                                <div class="card animate fadeLeft">
                                    <div class="card-content red accent-2 white-text">
                                        <p class="card-stats-title"><i class="material-icons">attach_money</i>Total
                                            Sales</p>
                                        <h4 class="card-stats-number white-text">Php 134,500.85</h4>
                                        <p class="card-stats-compare">
                                            <i class="material-icons">keyboard_arrow_up</i> 21.80% <span
                                ...
                                <div class="card animate fadeRight">
                                    <div class="card-content orange lighten-1 white-text">
                                        <p class="card-stats-title"><i class="material-icons">trending_up</i> Today
                                            Profit</p>
                                        <h4 class="card-stats-number white-text">Php 12,806.52</h4>
                                        <p class="card-stats-compare">
                                ...
                                <div class="card animate fadeRight">
                                    <div class="card-content green lighten-1 white-text">
                                        <p class="card-stats-title"><i class="material-icons">content_copy</i> New
                                            Invoice</p>
                                        <h4 class="card-stats-number white-text">180</h4>
                                        <p class="card-stats-compare">
                                        ...
                                        <ul class="widget-timeline mb-0">
                                            ...
                                            <li class="timeline-items timeline-icon-red active">
                                                ...
                                                <div class="timeline-content">
                                                    <img src="app-assets/images/icon/pdf.png" alt="document"
                                    ...
                                    <div class="card animate fadeUp">
                                        <div class="card-move-up waves-effect waves-block waves-light">
                                            <div class="move-up cyan darken-1">
                                                <div>
                                                    <span class="chart-title white-text">Income</span>
                                                    <div class="chart-revenue cyan darken-2 white-text">
                                                        <p class="chart-revenue-total">Php 134,500.85</p>
                                                        <p class="chart-revenue-per"><i
                                                                class="material-icons">arrow_drop_up</i> 21.80 %</p>
                                                    </div>
                                                ...
                                                <div class="trending-line-chart-wrapper"><canvas id="revenue-line-chart"
                                                        height="70"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-content">
                                            ...
                                            <div class="col s12 m3 l3">
                                                <div id="doughnut-chart-wrapper">
                                                    ...
                                                    <div class="doughnut-chart-status" >
                                                        <p class="center-align font-weight-600 mt-4" style="margin-top:-50px !important;">4500</p>
                                            ...
                                            <div class="col s12 m2 l2">
                                                <ul class="doughnut-chart-legend">
                                                    <li class="mobile ultra-small"><span
                                                            class="legend-color"></span>Room 1</li>
                                                    <li class="kitchen ultra-small"><span class="legend-color"></span>
                                                        Room 2</li>
                                                    <li class="home ultra-small"><span class="legend-color"></span> Room 3
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col s12 m5 l6">
                                                <div class="trending-bar-chart-wrapper"><canvas id="trending-bar-chart"
                            ...
                            <div class="row">
                                <div class="col s12 m12 l6">
                                    <ul id="projects-collection" class="collection z-depth-1 animate fadeLeft">
                                        <li class="collection-item avatar">
                                            <i class="material-icons cyan circle">attach_money</i>
                                            <h6 class="collection-header m-0">Income</h6>
                                            <p>Other Services</p>
                                        </li>
                                        <li class="collection-item">
                                            <div class="row">
                                                <div class="col s6">
                                                    <p class="collections-title">Massage</p>
                                                    <p class="collections-content">BlindMassage.inc</p>
                                                </div>
                                ...
                                <div class="col s12 m12 l6">
                                    <ul id="issues-collection" class="collection z-depth-1 animate fadeRight">
                                        <li class="collection-item avatar">
                                            <i class="material-icons red accent-2 circle">attach_money</i>
                                            <h6 class="collection-header m-0">Expense</h6>
                                            <p>Money spent</p>
                                        </li>
                                        <li class="collection-item">
                                            <div class="row">
