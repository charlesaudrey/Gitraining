        ...
        <div class="row">
          <div class="col s10 m6 l6 breadcrumbs-left">
            ...
            <ol class="breadcrumbs mb-0">
              ...
              <li class="breadcrumb-item active">Edit {{ strtoupper($user->name) }}
              </li>
            </ol>
          </div>
        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col s12 m6">
                        <div class="row">
                          <div class="col s12 input-field">
                            ...
                            <label for="lname">Email <small>* can't edit email</small></label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col s12">
                        ...
                        @foreach ($roles as $role)
                          <label class="pl-10">
                            <input type="checkbox" name="roles[]" {{ $user->roles->firstWhere('name', $role->name) ? 'checked' : '' }} />
                            <span>{{ $role->name }}</span>
                          </label>
                        @endforeach
                      </div>
                      ...
                      <div class="col s12">
                        ...
                        @forelse ($properties as $property)
                          <label class="pl-5">
                            <input type="checkbox" name="properties[]" {{ $user->properties->firstWhere('name', $property->name) ? 'checked' : '' }} />
