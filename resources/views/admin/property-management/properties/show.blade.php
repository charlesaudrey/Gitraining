...
@section('content')
@include('admin.property-management.properties.assets.create-room-modal')

@foreach ($property->rooms as $room)
  @include('admin.property-management.properties.assets.edit-room-modal')
@endforeach
        ...
        <div class="row">
          <div class="col s10 m6 l6">
            ...
            <ol class="breadcrumbs mb-0">
              ...
              <li class="breadcrumb-item">
                <a href="#" style="color: rgba(255,255,255,.85)">{{ $property->name }}</a>
              </li>
